...
public class Letter {
	...
	public Letter(int letter_no, int receive_user_no, int send_user_no, int item_no, String letter_title,
	...
	public Letter(int receive_user_no, int send_user_no, int item_no, String letter_title,
			String letter_content, String letter_reg_datetime, int letter_check) {
		super();
		this.receive_user_no = receive_user_no;
		this.send_user_no = send_user_no;
