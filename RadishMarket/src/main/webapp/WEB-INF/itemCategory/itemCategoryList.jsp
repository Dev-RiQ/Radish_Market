		...
		<div id="list-box">
			<c:forEach var="category" items="${ itemCategoryList }">
				<div class="item-category">
					<table>
						<tr>
							<th class="no">${ category.item_category_no }</th>
							<th class="category">${ category.item_category_name }</th>
							<th class="update"><button
									onclick="location.href='/updateItemCategory.do?item_category_no=${ category.item_category_no }'">수정하기</button></th>
							<th class="delete"><button 
									onclick="location.href='/deleteItemCategory.do?item_category_no=${ category.item_category_no }'">삭제하기</button></th>
						</tr>
					</table>
				</div>
			</c:forEach>
		</div>
		<button class="add-btn" onclick="location.href='/insertItemCategory.do'">카테고리
			추가하기</button>
	</div>
</section>
