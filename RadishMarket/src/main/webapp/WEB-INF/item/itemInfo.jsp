	...
	<div class="thelook">
        ...
        <div class="itemandtxt">
          <div class="itemimg">
            ...
            <div class="txts">
                <div class="propir">
					<img class="propir-img" alt="유저 이미지" src="/images/${user.user_img ne '' ? user.user_img : 'usersDefaultImg.png'}"> 
	                <div class="namebox">
						<p><a href='/itemListUser.do?user_no=${user.user_no}'>${user.user_nickname}</a></p>
						<span><a href='/listItem.do?filter=true&gu=${user.user_gu}&dong=${user.user_dong}'>${user.user_dong}</a></span>
	                </div>
				</div>
	              <div class="ondobox">
	                <!--온도-->
          	...
          	<c:forEach var="i" begin="0" end="${hotItemList.size()-1}">
				<div class="child" style="cursor: pointer;"
					...
					<div class="saleprice">
						...
						<h5>
							 ${hotItemList.get(i).item_price}원
						</h5>
